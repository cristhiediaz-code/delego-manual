# 12. Recurrencias y tareas planificadas a futuro
...
Una recurrencia se define **al crear o editar una tarea**, en la pestaña **Recurrencia** del modal de tarea (también accesible desde Editar Recurrencia, §12.3).
...
- **Editar Recurrencia** (lápiz) — abre el editor de la recurrencia/tarea (§12.1).
